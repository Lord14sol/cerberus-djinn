...
// Serve static files from draco-ui (Dashboard Frontend)
const uiPath = path.join(__dirname, '../../cerberus-djinn/draco-ui');
...
/**
 * Interactive Oracle Chat
 */
app.post('/api/oracle/chat', async (req: Request, res: Response) => {
    const { message } = req.body;

    try {
        const response = await orchestrator.getAIResponse(message);
